...
// +kubebuilder:rbac:groups=loadbalancer.takutakahashi.dev,resources=externalbackends,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=loadbalancer.takutakahashi.dev,resources=externalbackends/status,verbs=get;update;patch
...
func (r *ExternalBackendReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&loadbalancerv1beta1.ExternalBackend{}).
		Complete(r)
}
